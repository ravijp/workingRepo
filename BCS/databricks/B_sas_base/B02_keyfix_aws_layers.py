...
# MAGIC (a lexicon-matching SIGNAL row exists for the contactid - NOT the same as
# MAGIC "a transcript exists", because 03n only stores lexicon-matching
# MAGIC contactids; B04's stratum C learned this the hard way and now does its
# MAGIC own transcript-exists check). The capture gate here is the AWS
